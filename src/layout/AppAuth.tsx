...
export default function AppAuth() {
    const [formState, formAction] = useActionState<FormState, FormData>(AuthCredentials, { error: "" });
    ...
    const handleLogin = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const result = formAction(new FormData(e.currentTarget));
        } catch (error) {
            console.error(error);
            setLoading(false);
        }
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            >
                                                {showPassword ? (
                                                    <Image src="/images/icons/eye.svg" width={20} height={20} alt="Eye" className="fill-gray-500 dark:fill-gray-400" />
                                                ) : (
                                                    <Image src="/images/icons/eye-close.svg" width={20} height={20} alt="Eye Close" className="fill-gray-500 dark:fill-gray-400" />
                                                )}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            <Checkbox name="remember" checked={isChecked} onChange={setIsChecked} />
